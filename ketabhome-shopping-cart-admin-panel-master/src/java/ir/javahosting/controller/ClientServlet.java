...
public class ClientServlet extends HttpServlet {
	...
	private void logout(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		response.getWriter().write("You have exited successfully...");
		response.setHeader("Refresh", "2;URL="+request.getContextPath());
	...
	private void login(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if(customer==null){
			response.getWriter().write("The username or password is incorrect or your username is not activated... Please wait for 5 seconds.");
	...
	private void activeCustomer(HttpServletRequest request,
		...
		response.getWriter().write("Activation was successful.");
		response.setHeader("Refresh", "2;URL="+request.getContextPath());
	...
	private void customerRegist(HttpServletRequest request,
		...
		request.setAttribute("message", "Registration was successful. We have an email."
                        + "Activation to "+customer.getEmail()+"We sent it, please read it.");
	...
	private void buyBook(HttpServletRequest request,
		...
		request.setAttribute("message", "The purchase was made successfully！<a href='javascript:window.history.back()'>بازگشت</a>");
		try {
